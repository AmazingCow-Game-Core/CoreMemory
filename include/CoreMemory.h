...
#ifndef __CoreMemory_include_CoreMemory_h__
#define __CoreMemory_include_CoreMemory_h__

//This is a umbrella header indented to ease the inclusion of all files
//needed to use the Memory Game Core.
...
#endif // defined(__CoreMemory_include_CoreMemory_h__) //
